...
return{
    ...
    challenges={
        ...
        {"Challenge 7",  "Hard Mode",              "Rank requirements are 1.5x harder."},
        {"Challenge 8",  "One Try+",               "Challenge 1, but getting "..CHAR.icon.rankB.." or "..CHAR.icon.rankA.." rank does not unlock modes."},
        {"Challenge 9",  "One Try++",              "Challenge 1, but you have to get "..CHAR.icon.rankU.." or "..CHAR.icon.rankX.." to unlock modes."},
