...
return{
    ...
    [0]={"--",  "",            "You can choose a challenge in the Mods menu."},
        ...
        {"C4",  "description", "detailed description"},
        {"C5",  "description", "detailed description"},
        {"C6",  "description", "detailed description"},
        {"C7",  "description", "detailed description"},
        {"C8",  "description", "detailed description"},
